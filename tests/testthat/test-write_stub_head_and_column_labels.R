test_that("columns names are correct, no labels, no spanner", {
  ...
  # no group_by
  wb <- wb |>
    openxlsx2::wb_add_worksheet(sheet = "gtcars_test_no_group", grid_lines = FALSE)
  ...
  wb <- wb |>
    openxlsx2::wb_add_worksheet(sheet = "gtcars_test_gt_table_group_by", grid_lines = FALSE)
  ...
  wb <- wb |>
    openxlsx2::wb_add_worksheet(sheet = "gtcars_test_rowname_col", grid_lines = FALSE)
  ...
  wb <- wb |>
    openxlsx2::wb_add_worksheet(sheet = "gtcars_test_both", grid_lines = FALSE)
