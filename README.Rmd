...
[![Codecov test coverage](https://codecov.io/gh/yannsay/gtopenxlsx/branch/main/graph/badge.svg)](https://app.codecov.io/gh/yannsay/gtopenxlsx?branch=main)
<!-- badges: end -->
...
If you want to use `gtopenxlsx` as a base for your own rendering, you can follow this article that looks into `gt_to_xlxs.`
